{!! Form::open(['url'=>action('DashboardController@postGood').$id_url,'method'=>'post', 'role'=>'form', 'class'=>'form-horizontal','id'=>'goodform']) !!}
	...
	<div class="form-group">
	    {!! Form::label('r_price',@trans('prompts.r_price'),['class'=>'control-label col-sm-3'] ) !!}
	    <div class="col-sm-9">
	...
	<div class="form-group">
	    {!! Form::label('w_price',@trans('prompts.w_price'),['class'=>'control-label col-sm-3'] ) !!}
	    <div class="col-sm-9">
